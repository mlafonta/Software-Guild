...
public class VendingMachineServiceImp1Test {
    ...
    public VendingMachineServiceImp1Test() {
        VendingMachineDao dao = new VendingMachineDaoStubImp1();
        VendingMachineAuditDao auditDao = new VendingMachineAuditDaoStubImp1();

        service = new VendingMachineServiceImp1(dao, auditDao);
    }
